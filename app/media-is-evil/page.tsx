...
export default function DigitalVsPhysicalMinimalismPage() {
    return (
                ...
                <article className="max-w-3xl space-y-6 bg-white/70 px-6 py-6 text-base leading-relaxed text-black shadow-lg shadow-black/10 sm:text-lg dark:bg-background/60 dark:text-white dark:shadow-black/30">
                    <header className="space-y-2 border-b border-black/20 pb-4 dark:border-white/20">
                        ...
                        <p className="text-sm opacity-60 sm:text-base">
                            By Finnian Murphy &middot; Fall 2025
                        </p>
                    </header>
                    ...
                    <p>
                        Like the humble coca leaf that went from being used for medicinal teas to being purified, processed and synthesized into the brain-melting, life destroying drug cocaine, our media have gone from the harmlessly entertaining long-form of books, plays, and artwork to being boiled down into the sneakingly addictive short form scrolling content that is inescapable as long as you have internet access. 
                        Your brain is the most powerful tool you have. Just like you shouldn't voluntarily destroy it with alcohol, don't voluntarily destroy it by succumbing to the siren song of total brain shutoff scroll sessions. 
                        Create, explore, and make the world a better place. Don't just absorb the slop churned out by the Meta Machine. 
                    </p>
